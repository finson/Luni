...
#define DEVICE_MINIMUM_MICROSECOND_INTERVAL 100    // microseconds
#define DEVICE_DEFAULT_MICROSECOND_INTERVAL 200

#define DEVICE_MINIMUM_MILLISECOND_INTERVAL 10     // milliseconds
#define DEVICE_DEFAULT_MILLISECOND_INTERVAL 19

// Combine device number and unit number to get full handle

#define makeDeviceHandle(DEVICE_NUMBER, UNIT_NUMBER) ((int)(((DEVICE_NUMBER & 0x7F) << 8) | (UNIT_NUMBER & 0x7F)))

// Extract 7-bit index values from a 16-bit handle

#define getUnitNumberFromHandle(HANDLE) ((int)((HANDLE) & 0x7F))
#define getDeviceNumberFromHandle(HANDLE) ((int)(((HANDLE) >> 8) & 0x7F))
